...
public:
	...
	bool BlitEx(SDL_Texture* texture, int x, int y, SDL_Rect* section = NULL, float speed = 1.0f, float scale=1.0f, double angle = 0, int pivot_x = INT_MAX, int pivot_y = INT_MAX);
